...
export const EXPLAINABILITY_TARGET_TYPES = ['FINDING', 'HYPOTHESIS', 'RECOMMENDATION'] as const;

export type ExplainabilityTargetType = (typeof EXPLAINABILITY_TARGET_TYPES)[number];
